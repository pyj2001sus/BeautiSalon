...
public class PortfolioAdapter extends ArrayAdapter<DesignCase> {
    ...
    // 이를 기록해두면 종종 활용하게 됨
    private ArrayList<DesignCase> mList; // 표시할 데이터 배열
    ...
    public PortfolioAdapter(Context context, ArrayList<DesignCase> list) {
        // ArrayAdapter 만든것 처럼 new ArrayAdapter에 상응하는 일 -> super
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView profileImg = (ImageView) row.findViewById(R.id.profileimage);
        ...
        TextView createdOnText = (TextView) row.findViewById(R.id.createdOnTxt);
        createdOnText.setText(DateTimeUtill.getDateString(myDesignCase.getCreatedOn()));
        ...
        // 커스터마이징 할때는 super 문장을 전부 삭제하고 처음부터 직접 코딩
    }
