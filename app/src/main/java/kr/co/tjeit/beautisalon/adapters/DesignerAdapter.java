...
public class DesignerAdapter extends ArrayAdapter<Designer> {
    ...
    public DesignerAdapter(Context context, ArrayList<Designer> list) {
        ...
        // context 다음 인자 -> 직접 구현한 리스트뷰의 아이템의 id
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView designerNickname = (TextView) row.findViewById(R.id.designerNicknameTxt);
        designerNickname.setText(myDesigner.getNickName());

        TextView designerName = (TextView) row.findViewById(R.id.designerNameTxt);
        designerName.setText(myDesigner.getName());
        ...
        else if (myDesigner.getGender() == 1){
